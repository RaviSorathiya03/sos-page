      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">The School Of Science(sos)</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
             Jamnagar Road Near Nyara Village At Khambhala Taluka: Padadhari District: Rajkot
            </p>
            <MapboxMap />
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link href="/academics" className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                  Academics
                </Link>
              </li>
              <li>
                <Link href="/admissions" className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                  Admissions
                </Link>
              </li>
              <li>
                <Link href="/student-life" className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                  Student Life
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <form className="mt-4 space-y-4" action="/api/contact" method="POST">
              <div>
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2023 Evergreen Academy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
